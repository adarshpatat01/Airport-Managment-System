...
scheduled={'DL370':["10:12`",'Delhi',"On Time"],'KI784':['1:20','Pune',"Delayed"],'PH169':['12:20','Surat','20 Min Late'],'BH234':['15:20','Ahmedabad','Scheduled'],'PH234':['15:00','Prayagraj','On Time'],'BT452':['18:30','Malaysia','Scheduled'],'KR234':['15:20','Canada','Scheduled']}
...
def stamain():#standard user control panel
    ...
    tk.Button(master=stamainsc,text="Exit The Program", bg = 'black', fg = 'white', command=exit).grid(row=4,column=0)
